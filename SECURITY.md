...
If you discover a security issue in cloud-itonami-isic-0163, **do not open a
...
This repository implements the **Governor** for post-harvest crop-processing
...
1. **Hard violations in Governor rules must never be overridable** — a rule
   marked as HARD (e.g., `:already-processed`, `:defect-rate-exceeded`,
   `:pest-infestation-detected`) blocks the proposal unconditionally
...
- Include documentation of the post-harvest quality/food-safety rationale
