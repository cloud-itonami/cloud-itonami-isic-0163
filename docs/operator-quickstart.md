# Operator Quickstart — Post-Harvest Crop Activities Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0163** (`cloud-itonami-isic-0163`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0163.git
cd cloud-itonami-isic-0163
```
...
- Blueprint governor key: `postharvest-governor`
- Likely source path: `postharvest.governor.cljc`
