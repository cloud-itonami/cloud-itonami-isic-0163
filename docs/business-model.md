# Business Model: Post-Harvest Crop Activities Coordination
...
## Classification
- Repository: `cloud-itonami-isic-0163` ([github.com/cloud-itonami/cloud-itonami-isic-0163](https://github.com/cloud-itonami/cloud-itonami-isic-0163))
- ISIC Rev.5: `0163` — Post-Harvest Crop Activities Coordination
- Domain: `:agriculture/post-harvest-crop-activities`
- Social impact: :food-security :food-safety :post-harvest-loss-reduction
- Actor: `:postharvest-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :agriculture/post-harvest-crop-activities — who wants
a governed execution scaffold they own instead of renting a closed SaaS.

## Offer
The actor coordinates the :intake :clean-trim :sort-grade :dry-or-store :pack :audit pipeline behind an independent Governor: the
...
Capability stack (required): :identity :forms :audit-ledger. Optional: :telemetry.
...
One managed tenant (:agriculture/post-harvest-crop-activities):
...
- Do not bypass the `:postharvest-governor` for production decisions.
