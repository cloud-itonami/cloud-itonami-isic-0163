(ns postharvest.advisor
  "PostHarvestAdvisor -- the LLM/decision-maker that proposes operations.

  The advisor operates purely at the proposal level; the Governor
  (postharvest.governor) independently validates all proposals against
